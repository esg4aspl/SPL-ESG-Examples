##
## @file C:\Users\ekincan\conformiq\OnlineShoppingBottomUp\TestSuite.tcl
##
## @date 2020/10/24 18:03:56
...
source "C:\Users\ekincan\conformiq\OnlineShoppingBottomUp\TestHarness.tcl"
...
proc "State Credit Card" {} {
    traceprint "Running test case 'State Credit Card'"
    #####################################################################
    # Conformiq generated test case
    #
    # This test case contains both inputs to the system under test as
    ...
    traceprint "Action: Tester sends inbound event MyMessage to port SelectCreditCard at 0.0"
